...
namespace i2fam.Web.Controllers
{
    ...
    public class AccountController : Controller
    {
        ...
        public AccountController(IAccountManager accountManager, IAuthorizationService authorizationService, ILogger<AuthorizationController> logger)
        {
        ...
        {
            if (!(await _authorizationService.AuthorizeAsync(this.User, id, AuthPolicies.ViewMemberByMemberIdPolicy)).Succeeded)
        ...
        public async Task<IActionResult> GetUserByUserName(string userName)
        {
            ...
            if (!(await _authorizationService.AuthorizeAsync(this.User, appUser?.Id ?? "", AuthPolicies.ViewMemberByMemberIdPolicy)).Succeeded)
                return new ChallengeResult();
        ...
        public async Task<IActionResult> UpdateUser(string id, [FromBody] UserEditViewModel user)
        {
            ...
            var manageUsersPolicy = _authorizationService.AuthorizeAsync(this.User, id, AuthPolicies.ManageMemberByMemberIdPolicy);
            ...
            if (ModelState.IsValid)
            {
                ...
                if (Utilities.GetUserId(this.User) == id && (appUser.UserName != user.Email || !string.IsNullOrWhiteSpace(user.NewPassword)))
                {
        ...
        {
            if (!(await _authorizationService.AuthorizeAsync(this.User, id, AuthPolicies.ManageMemberByMemberIdPolicy)).Succeeded)
                return new ChallengeResult();
        ...
        [HttpPost("users")]
        [Authorize(AuthPolicies.ManageMembersPolicy)]
        ...
        public async Task<IActionResult> ActivateUser(string id)
        {
            ...
            if (result.Item1)
            {
                ...
                throw new Exception("The following errors occurred whilst activating user: " + string.Join(", ", result.Item2));
        ...
        public async Task<IActionResult> DeactivateUser(string id)
        {
            ...
            var result = await _accountManager.UpdateUserAsync(appUser);
            if (!result.Item1)
                throw new Exception("The following errors occurred whilst deactivating user: " + string.Join(", ", result.Item2));
