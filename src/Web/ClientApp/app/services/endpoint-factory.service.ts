...
export class EndpointFactory {
    ...
    private readonly _signUpUrl: string = "/connect/signup";
    ...
    getSignUpEndpoint(userObject: any): Observable<Response> {
        ...
        return this.http.post(this._signUpUrl, JSON.stringify(userObject), { headers: headers })
            .map((response: Response) => {
                return response;
            })
            .catch(error => {
                return this.handleError(error, () => this.getSignUpEndpoint(userObject));
            });
    }
