...
export class AccountEndpoint extends EndpointFactory {
    ...
    private readonly _activateUserUrl: string = "/api/account/users/activate";
    private readonly _deactivateUserUrl: string = "/api/account/users/deactivate";
    ...
    getActivateUserEndpoint(userId: string): Observable<Response> {
        let endpointUrl = `${this._activateUserUrl}/${userId}`;
        ...
        return this.http.put(endpointUrl, null, this.getAuthHeader(true))
            ...
            .catch(error => {
                return this.handleError(error, () => this.getActivateUserEndpoint(userId));
            });
    }

    getDeactivateUserEndpoint(userId: string): Observable<Response> {
        let endpointUrl = `${this._deactivateUserUrl}/${userId}`;
        ...
        return this.http.put(endpointUrl, null, this.getAuthHeader(true))
            ...
            .catch(error => {
                return this.handleError(error, () => this.getDeactivateUserEndpoint(userId));
            });
    }
