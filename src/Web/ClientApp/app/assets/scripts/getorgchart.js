...
getOrgChart.prototype.print = function () {
    var b = this, d = this._X.element, k = this._X._zR, g = [], h = d.parentNode, j = k.style.display, a = document.body, c = a.childNodes, e;
    if (b._ay) {
        return
    }
    b._ay = true;
...
(function (global, undefined) {
    ...
    OrgChart = function () {
        return {
            init: function (element, data, renderNodeEventHandler) {
                console.log('orgChart Loaded!', data)
                ...
                getOrgChart.themes.myTheme =
                    {
                        ...
                        expandCollapseBtnRadius: 20,
                        box: '<path transform="matrix(0.5,0.5,-0.5,0.5,250,0)" class="get-box" d="M0 0 L500 0 L500 500 L0 500 Z"/>',
                ...
                var orgChart1 = new getOrgChart(element, {
                    theme: "myTheme",
                    expandToLevel: 3,
                    //levelSeparation: 100,
                    //siblingSeparation: 50,
                    primaryFields: ["firstName_Ar"],
                    ...
                    enableSearch: false,
                    enableMove: false,
                    //boxSizeInPercentage: { minBoxSize: { width: 1, height: 1 }, boxSize: { width: 5, height: 5 }, maxBoxSize: { width: 10, height: 10 } },
                    dataSource: data,
    ...
    if (typeof define === "function") {
        define([], function () { return new OrgChart(); });
    } else if (typeof global.alertify === "undefined") {
        global.orgChart = new OrgChart();
    }
