...
export class UserInfoComponent implements OnInit {
    ...
    constructor(private alertService: AlertService, private accountService: AccountService, private transaltionService: AppTranslationService) {
    }
    ...
    private saveSuccessHelper(user?: User) {
        ...
        if (this.isGeneralEditor) {
            if (this.isNewUser)
                this.alertService.showMessage("Success", `User \"${this.user.email}\" was created successfully`, MessageSeverity.success);
            else if (!this.isEditingSelf)
                this.alertService.showMessage("Success", `Changes to user \"${this.user.email}\" was saved successfully`, MessageSeverity.success);
        }
    ...
    get profile_email_validatoins_required_title(): string {
        return this.transaltionService.getTranslation('settings.tabs.profile.email.validations.required.title');
    }
    get profile_email_validatoins_required_message(): string {
        return this.transaltionService.getTranslation('settings.tabs.profile.email.validations.required.message');
    }
}
