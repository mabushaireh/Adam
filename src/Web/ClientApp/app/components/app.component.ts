...
import { Component, ViewEncapsulation, OnInit, OnDestroy, ViewChildren, AfterViewInit, QueryList, ElementRef, Inject } from "@angular/core";
...
export class AppComponent implements OnInit, AfterViewInit {
    ...
    constructor( @Inject(DOCUMENT) private document, storageManager: LocalStoreManager, private toastyService: ToastyService, private toastyConfig: ToastyConfig,
        ...
        // translationService.addLanguages(["en", "ar"]);
    ...
    ngOnInit() {
        ...
        if (this.configurations.language == "en") {
            this.document.getElementById('rtlSupport').setAttribute('href', '');
        }
        else {
            this.document.getElementById('rtlSupport').setAttribute('href', './dist/vendorRtl.css');
        }
    ...
    get fullName(): string {
        let user = this.authService.currentUser as User;

        return this.authService.currentUser ? user.firstName + " " + user.lastName : "";
    }
